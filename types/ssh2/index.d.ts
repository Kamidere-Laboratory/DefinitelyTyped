...
export interface ClientChannel extends Channel {
    ...
    once(event: "exit", listener: (code: string) => void): this;
...
export class Client extends EventEmitter {
    ...
    once(event: "tcp connection", listener: (details: TcpConnectionDetails, accept: AcceptConnection<ClientChannel>, reject: RejectConnection) => void): this;
    ...
    once(event: "x11", listener: (details: X11Details, accept: AcceptConnection<ClientChannel>, reject: RejectConnection) => void): this;
    ...
    once(event: "keyboard-interactive", listener: (name: string, instructions: string, lang: string, prompts: Prompt[], finish: KeyboardInteractiveCallback) => void): this;
    ...
    once(event: "unix connection", listener: (info: UNIXConnectionDetails, accept: AcceptConnection, reject: RejectConnection) => void): this;
...
export interface Session extends ServerChannel {
    ...
    once(event: "window-change", listener: (accept: SessionAccept, reject: RejectConnection, info: WindowChangeInfo) => void): this;
    ...
    once(event: "exec", listener: (accept: AcceptConnection<ServerChannel>, reject: RejectConnection, info: ExecInfo) => void): this;
    ...
    once(event: "subsystem", listener: (accept: AcceptConnection<ServerChannel>, reject: RejectConnection, info: SubsystemInfo) => void): this;
...
export class AgentProtocol extends Duplex {
    ...
    once(event: "sign", listener: (req: AgentInboundRequest, pubKey: ParsedKey, data: Buffer, options: SigningRequestOptions) => void): this;
